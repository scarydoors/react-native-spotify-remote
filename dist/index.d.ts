 ...
 * ```
*/
export declare const auth: import("react-native-spotify-remote/src/SpotifyAuth").SpotifyAuth;
/**
 ...
 * ```
*/
export declare const remote: import("react-native-spotify-remote/src/SpotifyRemote").SpotifyRemoteApi;
